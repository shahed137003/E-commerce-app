...
// Illustrations
import SignUpLight from "../assets/undraw_sign-up_qamz.svg";
import SignUpDark from "../assets/undraw_sign-up_qamz (1).svg";
    ...
    <div className="bg-gray-100 dark:bg-gray-900 flex items-center justify-center min-h-screen px-4 sm:px-6">
      <div
        className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-10 items-center
                   ...
                   rounded-3xl py-8 sm:py-10 px-6 sm:px-10 
      ...
      >
        ...
        <div className="flex justify-center items-center relative">
          ...
          <motion.img
            src={SignUpLight}
            alt="Sign Up Illustration Light"
            className="w-72 md:w-96 drop-shadow-lg block dark:hidden"
            animate={{
              y: [0, -20, 0],
              scale: [1, 1.05, 1],
              rotate: [0, 2, -2, 0],
          ...
          <motion.img
            src={SignUpDark}
            alt="Sign Up Illustration Dark"
            className="w-72 md:w-96 drop-shadow-lg hidden dark:block"
            animate={{
              y: [0, -20, 0],
              scale: [1, 1.05, 1],
              rotate: [0, 2, -2, 0],
        ...
        <div className="flex flex-col items-center md:items-start">
          {/* Title */}
          <h1
            className="font-extrabold text-3xl sm:text-4xl text-center md:text-left mb-6 sm:mb-8 
          ...
          {/* Extra Link */}
          <p className="mt-6 text-sm sm:text-md text-gray-600 dark:text-gray-400 text-center md:text-left">
